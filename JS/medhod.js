...
//  인덱싱
console.log(str1[4]);
console.log(str1[3] + str1[15] + str1[7]);
console.log(str1);
...
console.log(fruit.indexOf("2")); //없는 문자는 -1 반환

// charAt(인덱스 번호)
console.log(fruit.charAt(3));

// slice(인덱스 번호-하나,두개 가능)
...
/* find */
console.log("-- findResult = multiArr.find(function (el) --");
...
for (let area in areaNum) {
  console.log(area); // object 의 key 출력됨
  //   areaNum.Seoul
  //   areaNum["Seoul"] --> 대괄호 접근법을 이용해서 value 에 접근
